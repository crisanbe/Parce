...
fun Email(nameError: Boolean, email: String, onTextChanged: (String) -> Unit) {
    TextField(value = email,
        ...
        label = { Text(stringResource(com.gerotac.auth.R.string.TextField_Email_address)) },
        isError = nameError,
        ...
        leadingIcon = {
            Icon(
                ...
                contentDescription = stringResource(id = com.gerotac.auth.R.string.TextField_Email_address),
                tint = Color.Black
            )
            DividerIcon()
        })
