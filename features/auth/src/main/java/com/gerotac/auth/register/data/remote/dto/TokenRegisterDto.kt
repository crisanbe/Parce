...
import com.gerotac.auth.register.domain.model.RetunTokenRegister
...
fun TokenRegisterDto.toTokenRegis(): RetunTokenRegister {
    return RetunTokenRegister(
        authorization = com.gerotac.auth.register.domain.model.Authorization(
        ...
        state = state,
        status = status,
        user = com.gerotac.auth.register.domain.model.User(
            user.created_at,
            user.email,
            user.id,
            user.name,
