package com.gerotac.auth.updateuser.presentation.ui.updateintohome.student
...
import com.gerotac.components_ui.componets.CircularIndeterminateProgressBar
...
fun UpdateStudent(
    ...
    var studentName by remember { mutableStateOf(studentName) }
    ...
    var academic_program by remember { mutableStateOf(academic_program) }
    Column(
        modifier = Modifier
            .fillMaxSize()
            .wrapContentSize()
