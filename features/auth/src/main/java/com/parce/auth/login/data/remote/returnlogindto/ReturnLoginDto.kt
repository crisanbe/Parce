...
import com.parce.auth.login.domain.model.RetunTokenLogin
...
fun ReturnLoginDto.toTokenLogin(): RetunTokenLogin {
    return RetunTokenLogin(
        authorization = com.parce.auth.login.domain.model.Authorization(
        ...
        state = state,
        status = status,
        user = com.parce.auth.login.domain.model.User(
            user.name,
            user.email,
            user.role,
            user.user_status,
