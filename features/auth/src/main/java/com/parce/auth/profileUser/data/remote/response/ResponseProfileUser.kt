package com.parce.auth.profileUser.data.remote.response

import com.google.gson.annotations.SerializedName
import java.io.Serializable
import com.parce.auth.profileUser.domain.model.User
import com.parce.auth.profileUser.domain.model.Student
import com.parce.auth.profileUser.domain.model.Teacher
    ...
    val result = user.mapIndexed { _, user ->
        User(
            ...
            bussine = user.bussine?.let {
                com.parce.auth.profileUser.domain.model.Bussine(
